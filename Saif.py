...
logo = """
  ...
  \033[1;91m:》》》\033[1;93m+923239784245\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Saif-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Saif......................
\033[1;93m 
\033[1;94m    ____    _    ___ _____ 
 / ___|  / \  |_ _|  ___|
 \___ \ / _ \  | || |_   
  ___) / ___ \ | ||  _|  
 |____/_/   \_\___|_|    
...
╲▂
\033[1;93m
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mNadeemKhan\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
╲▂▏▏┈┈┈┈┈┈┈   
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To Saif▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mSaif\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mSaif
\033[1;94mSaif\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mSaif
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923239784245
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96m Saif \033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................Saif.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ")
...
▂┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊▔▔▔▔╲───────♡\033[1;96mLogin Saif \033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "Nadeem Khan
CorrectPassword = "Nadeem Khan
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Saif
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mSaif\033[1;95m♡──────────•◈•──────────♡"
		print('	   \033[1;94m♡\x1b[1;91m》》》》》》LOGIN Saif FACEBOOK《《《《《《\x1b[1;94m♡' )
		print('	' )
...
def menu():
	...
	try:
		...
		nama = a['name']https://github.com/GadNadem1/Saif.git
		id = a['id']
	except KeyError:
		os.system('clear')
		print"\033[1;91mYour Account is on Checkpoint"
		os.system('rm -rf login.txt')
		time.sleep(1)https://github.com/GadNadem1/Saif.git
		login()
	except requests.exceptions.ConnectionError:
		print"\x1b[1;92mThere is no internet connection"
		keluar()
	os.system("clear") #Dev:lve_hacker
	print logo
...
def super():
	...
	print "\033[1;96m--\033[1;91m> \033[1;91m0.\033[1;94mnadem
	pilih_super()
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mNadeemKhan\033[1;95m♡──────────•◈•──────────♡"
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mNadeemKhan\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:lve_hacker
...
if __name__ == '__main__':
	login()
	[•]===[DRACO-TOOLS-UPDATE-DONE]===[•]

[+] Saif  = FIKE CLONE
[+] Saif = GAMJ ID CLONj
[+] Saif = ACTIVE ID CLONJ
[+] Saif = RANDOM CLONi
[+] Saif = GMAIL Saifhttps://github.com/GadNadem1/Again.py.git

[•] DAILY UPDATE 3:00PM
[•] 32/64 BIT SUPPORT & DATA/WORKING
